...
public class AuctionPropertyListActivity extends BaseFragmentActivity {
	...
	String auction_date; //date for auction listing
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		auction_date = getIntent().getStringExtra("AuctionDate");
		
		setTitleBarAndFooter();
		
		if(connectionManager.isConnected()) {
			new GetAuctionList().execute();
		}
		else {
	...
	public void setTitleBarAndFooter() {
		...
		titleText.setText(auction_date);
	...
	public class GetAuctionList extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			// TODO Auto-generated method stub
			try {
				jObj = api.getAuctionList(Preferences.getInstance(context).getSessionToken(), auction_date, pageCount);
	...
	public class saveShortlist extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(AuctionPropertyListActivity.this);
