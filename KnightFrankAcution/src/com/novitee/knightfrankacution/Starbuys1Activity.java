...
public class Starbuys1Activity extends AdvertisementsActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_starbuys1);
		
		showAD();
		setTitleBarAndFooter();
		
		listStarbuys = (ListView) findViewById(R.id.starbuys_list);
		refresh = (ProgressBar) findViewById(R.id.starbuys_refresh);
		loading = (ProgressBar) findViewById(R.id.starbuys_loading);
		...
		listStarbuys.setOnItemClickListener(new OnItemClickListener() {
	...
	public void setTitleBarAndFooter() {
		...
		fragmentTran.replace(R.id.starbuys_search, new SearchFragment());
		fragmentTran.commit();
	...
	public class GetStarbuys extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			if(loading.isShown()) {
				...
				listStarbuys.setVisibility(View.VISIBLE);
			}
			...
			try {
				...
				if(json_status == 1 && json_responseCode == 200){
					...
					if(propertyList.size() <= 0 && pageCount == 0) {
						...
						if(listStarbuys.getAdapter() == null) {
							listStarbuys.setAdapter(customList);
						}
					...
					listStarbuys.setOnScrollListener(new OnScrollListener() {
						...
						public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
							...
							if(end_flag.equals("1")) {
								if (listStarbuys.getLastVisiblePosition() == listStarbuys.getAdapter().getCount() -1 &&
									listStarbuys.getChildAt(listStarbuys.getChildCount() - 1).getBottom() <= listStarbuys.getHeight())
								{
...
//            row = inflator.inflate(R.layout.property_listview_layout, parent, false);
	...
	public class saveShortlist extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Starbuys1Activity.this);
