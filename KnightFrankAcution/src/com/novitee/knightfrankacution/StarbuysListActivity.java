...
public class StarbuysListActivity extends BaseFragmentActivity {
	...
	String starbuys_date; //date for auction listing
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		starbuys_date = getIntent().getStringExtra("StarbuysDate");
		
		setTitleBarAndFooter();
		
		if(connectionManager.isConnected()) {
			new GetStarbuysList().execute();
		}
		else {
	...
	public void setTitleBarAndFooter() {
		...
		titleText.setText(starbuys_date);
	...
	public class GetStarbuysList extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			// TODO Auto-generated method stub
			try {
				jObj = api.getStarbuysList(Preferences.getInstance(context).getSessionToken(), starbuys_date, pageCount);
	...
	public class saveShortlist extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(StarbuysListActivity.this);
