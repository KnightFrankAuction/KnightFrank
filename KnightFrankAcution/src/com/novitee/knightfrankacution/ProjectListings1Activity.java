...
public class ProjectListings1Activity extends AdvertisementsActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_project_listings1);
	...
	public class saveShortlist extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ProjectListings1Activity.this);
