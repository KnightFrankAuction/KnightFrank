...
public class FilterListActivity extends BaseFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		filterList = (ArrayList<String>) getIntent().getStringArrayListExtra("FilterList");
	...
	public class saveShortlist extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(FilterListActivity.this);
	...
	private class Filter extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			// TODO Auto-generated method stub
			try {
				jObj = api.filter(pref.getSessionToken(), filterList.get(0), filterList.get(1), filterList.get(2), filterList.get(3), filterList.get(4), filterList.get(5), filterList.get(6), filterList.get(7), pageCount); //"1" for page_count
