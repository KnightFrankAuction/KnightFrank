...
public class NonExclusiveAuthorityActivity extends BaseFragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_non_exclusive_authority);
	...
	private void LoadData() {
		// TODO Auto-generated method stub
		editPropertyPostal = (EditText) findViewById(R.id.non_ex_edit_property_postal);
		editPropertyAddress1 = (EditText) findViewById(R.id.non_ex_edit_property_address1);
		editPropertyAddress2 = (EditText) findViewById(R.id.non_ex_edit_property_address2);
		editPropertyBuildingName = (EditText) findViewById(R.id.non_ex_edit_property_building_name);
		editPropertyType = (EditText) findViewById(R.id.non_ex_edit_property_type);
		editPropertyFloor = (EditText) findViewById(R.id.non_ex_edit_property_floor_area);
		editPropertyLand = (EditText) findViewById(R.id.non_ex_edit_property_land_area);
		editPropertyRooms = (EditText) findViewById(R.id.non_ex_edit_property_rooms);
		editPropetyYear = (EditText) findViewById(R.id.non_ex_edit_property_years);
		editPropertyExpiry = (EditText) findViewById(R.id.non_ex_edit_property_expiry);
		editPropertyRent = (EditText) findViewById(R.id.non_ex_edit_property_rent);
		rdHolderGp = (RadioGroup) findViewById(R.id.non_ex_rd_holder_gp);
		rdPossessionGp = (RadioGroup) findViewById(R.id.non_ex_rd_possession_gp);
		rdHolderFree = (RadioButton) findViewById(R.id.non_ex_rd_holder_free);
		rdHolderLead = (RadioButton) findViewById(R.id.non_ex_rd_holder_lead);
		rdPossessionVacant = (RadioButton) findViewById(R.id.non_ex_rd_possession_vacant);
		rdPossessionTenacy = (RadioButton) findViewById(R.id.non_ex_rd_possession_tenacy);
		txtAgentName = (TextView) findViewById(R.id.non_ex_agent_name);
		txtAgentLicense = (TextView) findViewById(R.id.non_ex_agent_license);
		txtAgentCompany = (TextView) findViewById(R.id.non_ex_agent_company);
		editTermsCommencement = (EditText) findViewById(R.id.non_ex_edit_terms_commencement);
		editTermsExpiry = (EditText) findViewById(R.id.non_ex_edit_terms_expiry);
		editTermsExpectedSale = (EditText) findViewById(R.id.non_ex_edit_terms_expected_sale);
		editTermsFeeSale = (EditText) findViewById(R.id.non_ex_edit_terms_fee_sale);
		editTermsFeeExpectedSale = (EditText) findViewById(R.id.non_ex_edit_terms_fee_expected_sale);
		editSoLanguage = (EditText) findViewById(R.id.non_ex_edit_so_language);
		editOwner1Name = (EditText) findViewById(R.id.non_ex_owner1_name);
		editOwner1Ic = (EditText) findViewById(R.id.non_ex_owner1_nric);
		editOwner1Postal = (EditText) findViewById(R.id.non_ex_owner1_postal);
		editOwner1Address1 = (EditText) findViewById(R.id.non_ex_owner1_address1);
		editOwner1Address2 = (EditText) findViewById(R.id.non_ex_owner1_address2);
		editOwner1BuildingName = (EditText) findViewById(R.id.non_ex_owner1_building_name);
		editOwner2Name = (EditText) findViewById(R.id.non_ex_owner2_name);
		editOwner2Ic = (EditText) findViewById(R.id.non_ex_owner2_nric);
		editOwner2Postal = (EditText) findViewById(R.id.non_ex_owner2_postal);
		editOwner2Address1 = (EditText) findViewById(R.id.non_ex_owner2_address1);
		editOwner2Address2 = (EditText) findViewById(R.id.non_ex_owner2_address2);
		editOwner2BuildingName = (EditText) findViewById(R.id.non_ex_owner2_building_name);
		txtSaleName = (TextView) findViewById(R.id.non_ex_sale_name);
		txtSaleLicense = (TextView) findViewById(R.id.non_ex_sale_license);
		btnSubmit = (Button) findViewById(R.id.non_ex_submit);
		
		//Signature
		btnOwner1Sign = (Button) findViewById(R.id.non_ex_owner1_sign);
		btnOwner2Sign = (Button) findViewById(R.id.non_ex_owner2_sign);
		btnSalePersonSign = (Button) findViewById(R.id.non_ex_sale_sign);
		imgOwner1Sign = (ImageView) findViewById(R.id.non_ex_owner1_img);
		imgOwner2Sign = (ImageView) findViewById(R.id.non_ex_owner2_img);
		imgSalePersonSign = (ImageView) findViewById(R.id.non_ex_sale_img);
	...
	public void setTitleBarAndFooter() {
		...
		titleText.setText("Non Exclusive Authority to Sell");
		titleImage.setVisibility(View.GONE);
		
		fragmentTran = getSupportFragmentManager().beginTransaction();
		fragmentTran.replace(R.id.non_exclusive_authority_footer, new FooterFragment());
		fragmentTran.commit();
	...
	private void setDate(EditText editText) {
		...
		DatePickerDialog dateDialog = new DatePickerDialog(NonExclusiveAuthorityActivity.this,
				datePicker, 
	...
	private void MakeSignature(ImageView imgView) {
		...
		final Dialog dialog = new Dialog(NonExclusiveAuthorityActivity.this);
	...
	private void onSubmit() {
		...
		if(connectionManager.isConnected()) {
			new GetNonExclusiveAuthority().execute();
		}
		else {
	...
	private class GetNonExclusiveAuthority extends AsyncTask<Void, Void, Void> {
		JSONObject jObj;
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				jObj = api.NonExclusiveAuthority(pref.getSessionToken(), editPropertyPostal.getText().toString(), editPropertyAddress1.getText().toString(), editPropertyAddress2.getText().toString(), editPropertyBuildingName.getText().toString(), 
		...
		protected void onPostExecute(Void result) {
			...
			try {
				...
				if(status == 1 && responseCode == 200){
					...
					i.putExtra("PDF", pdf);
					i.putExtra("Email Title", "Non Exclusive Authority to Sell");
					i.putExtra("Api Link", CommonConstants.HOST + CommonConstants.STATUS_NON_EXCLUSIVE_AUTHORITY_URL);
					startActivity(i);
				}
